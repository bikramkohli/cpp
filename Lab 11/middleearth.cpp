 ...
 *
 *
 * @param xsize size of Middle-Earth's x axis
 * @param ysize size of Middle-Earth's y axis
 * @param num_cities number of cities in Middle-Earth
 * @param seed parameter used in a random number generator
 */
...
/**
 * @brief method to print info about the made up world
 *
 * @details method that prints out the number of city names, how many are being used, and their names
 * @date 11/16/2020
 */
...
/**
 * @brief method to print table of distances between cities
*/
 ...
 * @param city1 first city to compute distance
 * @param city2 second city to compute distance
 * @return distance between two passed cities
*/
...
/**
 * @brief method to get list of travel cities
 * @param length number of cities to travel to
 * @return returns list of cities to travel to
*/
